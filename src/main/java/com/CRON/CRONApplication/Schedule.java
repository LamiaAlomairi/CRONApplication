...
public class Schedule {
    // 50. CRON expression for run every 10 minutes between 9:00 AM and 5:00 PM on weekdays
    @Scheduled(cron = "0 */10 9-16 * * SUN-THU")
    public void runJob() {
        System.out.println("Cron job is running...");
    }

//    // 49. CRON expression for run at 3:00 AM on weekdays in the month of November
//    @Scheduled(cron = "0 0 3 * 11 SUN-THU")
//    public void runJob() {
//        System.out.println("Cron job is running...");
//    }

//    // 48. CRON expression for run at 5:30 PM on the first day of every month
//    @Scheduled(cron = "0 30 17 1 * *")
//    public void runJob() {
//        System.out.println("Cron job is running...");
//    }

//    // 47. CRON expression for run at 1:30 PM on the second to last Friday of every month
//    @Scheduled(cron = "0 30 13 * * FRIL-2")
//    public void runJob() {
//        System.out.println("Cron job is running...");
//    }

//    // 46. CRON expression for run every 2 hours between 10:00 PM and 6:00 AM
//    @Scheduled(cron = "0 0 */2 * * *")
//    public void runJob() {
//        System.out.println("Cron job is running...");
//    }

//    // 45. CRON expression for run at 8:00 AM every day, except for the last day of the month
//    @Scheduled(cron = "0 0 8 1-28 * *")
//    public void runJob() {
//        System.out.println("Cron job is running...");
//    }
...
//    // 41. CRON expression for run at 12:00 PM on the first Monday of every month
